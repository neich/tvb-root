...
class TestRegionMappingImporter(TransactionalTestCase):
    ...
    def test_import_no_surface_or_connectivity(self):
        ...
        """
        try:
            TestFactory.import_region_mapping(self.TXT_FILE, None, self.connectivity.gid, self.test_user, self.test_project)
        ...
        try:
            TestFactory.import_region_mapping(self.TXT_FILE, self.surface.gid, None, self.test_user, self.test_project)
    ...
    def _import_from_file(self, import_file):
        ...
        This method tests import of region mapping from TXT file
        """
        region_mapping_index = TestFactory.import_region_mapping(import_file, self.surface.gid, self.connectivity.gid, self.test_user, self.test_project)
    ...
    def test_import_wrong_file_content(self):
        ...
        """
        try:
            TestFactory.import_region_mapping(self.WRONG_FILE_1, self.surface.gid, self.connectivity.gid, self.test_user, self.test_project)
        ...
        try:
            TestFactory.import_region_mapping(self.WRONG_FILE_2, self.surface.gid, self.connectivity.gid, self.test_user, self.test_project)
        ...
        try:
            TestFactory.import_region_mapping(self.WRONG_FILE_3, self.surface.gid, self.connectivity.gid, self.test_user, self.test_project)
